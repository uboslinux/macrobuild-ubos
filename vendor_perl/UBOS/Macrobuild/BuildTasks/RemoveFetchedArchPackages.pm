# 
# Removes packages fetched from Arch marked to be removed
#

use strict;
use warnings;

package UBOS::Macrobuild::BuildTasks::RemoveFetchedArchPackages;
...
sub new {
    ...
    my @removePackagesTasksSequence = map { ( "remove-fetched-packages-$_" ) } @dbs;
